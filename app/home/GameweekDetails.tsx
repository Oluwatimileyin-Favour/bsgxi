...
export default function GameweekDetails({gameweek}: {gameweek: Gameweek}) {

    return (
        <div className="flex flex-col gap-2 items-center">
            <h2 className="font-bold text-3xl text-rose-900 dark:text-rose-500">Gameweek {gameweek.gameweekID + 1}</h2>
